...
public class IRGenerator {
    ...
    public Module generateModule() {
        ...
        try (BufferedWriter stdout = new BufferedWriter(new FileWriter("D:\\BUAA_Compile_2024\\homework5-mips\\src\\llvm_ir.txt"))) {
    ...
    public void generateFuncFParam(SyntaxNode node) {
        ...
        symbol.setIsParam(true); //是形参，用于getelementptr的取址方式
        stack.peek().addSymbol(symbol);
